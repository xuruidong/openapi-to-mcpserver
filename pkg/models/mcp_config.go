...
type ServerConfig struct {
	...
	PassthroughAuthHeader     *bool                    `yaml:"passthroughAuthHeader,omitempty" json:"passthroughAuthHeader,omitempty"` // If true, pass through Authorization header even without downstream security
}
